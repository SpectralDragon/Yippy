...
class HistoryItem: NSObject, Identifiable {
    ...
    init(
        ...
        cache: HistoryCache,
        metadata: HistoryItemMetadata? = nil
    ) {
        self.fsId = fsId
    ...
    func detectAndSetCategory(createdAt: Date? = nil) {
        self.metadata = CategoryDetector.shared.detectCategory(for: self, createdAt: createdAt)
    }
